...
if set(os.listdir("CMSSW_8_0_20")) != set(["src", ".gitignore"]):
    ...
    print """Now setting up CMSSW_8_0_20 area for combine..."""
...
with utilities.cd("CMSSW_8_0_20/src"):
    subprocess.check_call(["scram", "b", "-j", "10"])

print "Compiling TemplateBuilder"

subprocess.check_call("cd CMSSW_8_0_20 && eval $(scram ru -sh) && cd ../TemplateBuilder && make", shell=True)
gitignore = """
obj/*
buildTemplate.exe
.gitignore
