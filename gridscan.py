...
def run(otherfa3s, otherfa2s, otherfL1s, otherfL1Zgs):
...
run(otherfa3s, otherfa2s, otherfL1s, otherfL1Zgs)

otherfa3s = [np.arange(0.02, 0.06, 0.01)]
otherfa2s = [[]]
otherfL1s = [np.arange(0.1, 0.5, 0.005)]
otherfL1Zgs = [[-0.05]]
