...
float update_xsec(TString inputname, float xsec) {
        ...
        else if (inputname.Contains("ZH120")) { new_xsec = 0.864*0.0004106877051958817;}
        else if (inputname.Contains("ZH124")) { new_xsec = 0.7809*0.0006322344128856341;}
        ...
        else if (inputname.Contains("ZH126")) { new_xsec = 0.7431*0.0007650556125370585;}
        else if (inputname.Contains("ZH130")) { new_xsec = 0.6735*0.0010674878938974918;}
