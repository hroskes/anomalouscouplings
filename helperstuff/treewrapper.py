...
#########################
    ...
    binning_4couplings_VBFdecay_JESUp = tuple((name+"_JESUp", bins) for name, bins in binning_4couplings_VBFdecay)
    binning_4couplings_VBFdecay_JESDn = tuple((name+"_JESDn", bins) for name, bins in binning_4couplings_VBFdecay)
    binning_4couplings_VBFdecay_JERUp = tuple((name+"_JERUp", bins) for name, bins in binning_4couplings_VBFdecay)
    binning_4couplings_VBFdecay_JERDn = tuple((name+"_JERDn", bins) for name, bins in binning_4couplings_VBFdecay)
    ...
    binning_4couplings_HadVHdecay_JESUp = tuple((name+"_JESUp", bins) for name, bins in binning_4couplings_HadVHdecay)
    binning_4couplings_HadVHdecay_JESDn = tuple((name+"_JESDn", bins) for name, bins in binning_4couplings_HadVHdecay)
    binning_4couplings_HadVHdecay_JERUp = tuple((name+"_JERUp", bins) for name, bins in binning_4couplings_HadVHdecay)
    binning_4couplings_HadVHdecay_JERDn = tuple((name+"_JERDn", bins) for name, bins in binning_4couplings_HadVHdecay)
    ...
    binning_4couplings_photons_VBF = (
      ("D_0minus_Zg_VBF", [.333, .667]),
      ("D_CP_Zg_VBF_new", [0.]),
      ("D_0hplus_Zg_VBF", [.333, .667]),
      ("D_int_Zg_VBF_new", [0.]),
      ("D_0minus_gg_VBF", [.333, .667]),
      ("D_CP_gg_VBF_new", [0.]),
      ("D_0hplus_gg_VBF", [.333, .667]),
      ("D_int_gg_VBF_new", [0.]),
    )
    binning_4couplings_photons_VBF_JECUp = tuple((name+"_JECUp", bins) for name, bins in binning_4couplings_photons_VBF)
    binning_4couplings_photons_VBF_JECDn = tuple((name+"_JECDn", bins) for name, bins in binning_4couplings_photons_VBF)
    binning_4couplings_photons_VBF_JESUp = tuple((name+"_JESUp", bins) for name, bins in binning_4couplings_photons_VBF)
    binning_4couplings_photons_VBF_JESDn = tuple((name+"_JESDn", bins) for name, bins in binning_4couplings_photons_VBF)
    binning_4couplings_photons_VBF_JERUp = tuple((name+"_JERUp", bins) for name, bins in binning_4couplings_photons_VBF)
    binning_4couplings_photons_VBF_JERDn = tuple((name+"_JERDn", bins) for name, bins in binning_4couplings_photons_VBF)
    ...
    binning_4couplings_photons_HadVH = (
      ("D_0minus_Zg_HadVH", [.333, .667]),
      ("D_CP_Zg_HadVH_new", [0.]),
      ("D_0hplus_Zg_HadVH", [.333, .667]),
      ("D_int_Zg_HadVH_new", [0.]),
      #("D_0minus_gg_HadVH", [.333, .667]),
      #("D_CP_gg_HadVH_new", [0.]),
      #("D_0hplus_gg_HadVH", [.333, .667]),
      #("D_int_gg_HadVH_new", [0.]),
    )
    binning_4couplings_photons_HadVH_JECUp = tuple((name+"_JECUp", bins) for name, bins in binning_4couplings_photons_HadVH)
    binning_4couplings_photons_HadVH_JECDn = tuple((name+"_JECDn", bins) for name, bins in binning_4couplings_photons_HadVH)
    binning_4couplings_photons_HadVH_JESUp = tuple((name+"_JESUp", bins) for name, bins in binning_4couplings_photons_HadVH)
    binning_4couplings_photons_HadVH_JESDn = tuple((name+"_JESDn", bins) for name, bins in binning_4couplings_photons_HadVH)
    binning_4couplings_photons_HadVH_JERUp = tuple((name+"_JERUp", bins) for name, bins in binning_4couplings_photons_HadVH)
    binning_4couplings_photons_HadVH_JERDn = tuple((name+"_JERDn", bins) for name, bins in binning_4couplings_photons_HadVH)
    ...
    @MakeJetSystematics
    def D_4couplings_photons_VBF_raw(self):
      if self.notdijet: return -999
      return self.D_4couplings_general_raw(*self.binning_4couplings_photons_VBF)
    @MakeJetSystematics
    def D_4couplings_photons_VBFdecay_raw(self):
      if self.notdijet: return -999
      return self.D_4couplings_general_raw(*self.binning_4couplings_photons_VBFdecay)
    @MakeJetSystematics
    def D_4couplings_photons_HadVH_raw(self):
      if self.notdijet: return -999
      return self.D_4couplings_general_raw(*self.binning_4couplings_photons_HadVH)
    @MakeJetSystematics
...
class TreeWrapper(TreeWrapperBase):
    ...
    def next(self):
        ...
        if self.useJEC:
            ...
            self.PFMET_corrected_jesUp = t.PFMET_corrected_jesUp
            ...
            self.PFMET_corrected_jesDn = t.PFMET_corrected_jesDn
        ...
        if self.useJES:
            #JESUp
            self.p_JJVBF_SIG_ghv1_1_JHUGen_JESUp                    = self.M2g1_VBF_JESUp               = t.p_JJVBF_SIG_ghv1_1_JHUGen_JESUp
            self.p_JJVBF_SIG_ghv4_1_JHUGen_JESUp                    = self.M2g4_VBF_JESUp               = t.p_JJVBF_SIG_ghv4_1_JHUGen_JESUp
            self.p_JJVBF_SIG_ghv1_1_ghv4_1_JHUGen_JESUp             = self.M2g1g4_VBF_JESUp             = t.p_JJVBF_SIG_ghv1_1_ghv4_1_JHUGen_JESUp
            self.p_JJVBF_SIG_ghv2_1_JHUGen_JESUp                    = self.M2g2_VBF_JESUp               = t.p_JJVBF_SIG_ghv2_1_JHUGen_JESUp
            self.p_JJVBF_SIG_ghv1_1_ghv2_1_JHUGen_JESUp             = self.M2g1g2_VBF_JESUp             = t.p_JJVBF_SIG_ghv1_1_ghv2_1_JHUGen_JESUp
            self.p_JJVBF_SIG_ghv1prime2_1_JHUGen_JESUp              = self.M2g1prime2_VBF_JESUp         = t.p_JJVBF_SIG_ghv1prime2_1E4_JHUGen_JESUp / 1e4**2
            self.p_JJVBF_SIG_ghv1_1_ghv1prime2_1_JHUGen_JESUp       = self.M2g1g1prime2_VBF_JESUp       = t.p_JJVBF_SIG_ghv1_1_ghv1prime2_1E4_JHUGen_JESUp / 1e4
            self.p_JJVBF_SIG_ghza1prime2_1_JHUGen_JESUp             = self.M2ghzgs1prime2_VBF_JESUp     = t.p_JJVBF_SIG_ghza1prime2_1E4_JHUGen_JESUp / 1e4**2
            self.p_JJVBF_SIG_ghv1_1_ghza1prime2_1_JHUGen_JESUp      = self.M2g1ghzgs1prime2_VBF_JESUp   = t.p_JJVBF_SIG_ghv1_1_ghza1prime2_1E4_JHUGen_JESUp / 1e4

            self.p_JJQCD_SIG_ghg2_1_JHUGen_JESUp                    = self.M2g2_HJJ_JESUp               = t.p_JJQCD_SIG_ghg2_1_JHUGen_JESUp
            self.p_JJQCD_SIG_ghg4_1_JHUGen_JESUp                                                        = t.p_JJQCD_SIG_ghg4_1_JHUGen_JESUp
            self.p_JJQCD_SIG_ghg2_1_ghg4_1_JHUGen_JESUp                                                 = t.p_JJQCD_SIG_ghg2_1_ghg4_1_JHUGen_JESUp

            self.p_HadZH_SIG_ghz1_1_JHUGen_JESUp                    = self.M2g1_HadZH_JESUp             = t.p_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.p_HadZH_SIG_ghz4_1_JHUGen_JESUp                    = self.M2g4_HadZH_JESUp             = t.p_HadZH_SIG_ghz4_1_JHUGen_JESUp
            self.p_HadZH_SIG_ghz1_1_ghz4_1_JHUGen_JESUp             = self.M2g1g4_HadZH_JESUp           = t.p_HadZH_SIG_ghz1_1_ghz4_1_JHUGen_JESUp
            self.p_HadZH_SIG_ghz2_1_JHUGen_JESUp                    = self.M2g2_HadZH_JESUp             = t.p_HadZH_SIG_ghz2_1_JHUGen_JESUp
            self.p_HadZH_SIG_ghz1_1_ghz2_1_JHUGen_JESUp             = self.M2g1g2_HadZH_JESUp           = t.p_HadZH_SIG_ghz1_1_ghz2_1_JHUGen_JESUp
            self.p_HadZH_SIG_ghz1prime2_1_JHUGen_JESUp              = self.M2g1prime2_HadZH_JESUp       = t.p_HadZH_SIG_ghz1prime2_1E4_JHUGen_JESUp / 1e4**2
            self.p_HadZH_SIG_ghz1_1_ghz1prime2_1_JHUGen_JESUp       = self.M2g1g1prime2_HadZH_JESUp     = t.p_HadZH_SIG_ghz1_1_ghz1prime2_1E4_JHUGen_JESUp / 1e4
            self.p_HadZH_SIG_ghza1prime2_1_JHUGen_JESUp             = self.M2ghzgs1prime2_HadZH_JESUp   = t.p_HadZH_SIG_ghza1prime2_1E4_JHUGen_JESUp / 1e4**2
            self.p_HadZH_SIG_ghz1_1_ghza1prime2_1_JHUGen_JESUp      = self.M2g1ghzgs1prime2_HadZH_JESUp = t.p_HadZH_SIG_ghz1_1_ghza1prime2_1E4_JHUGen_JESUp / 1e4

            self.p_HadZH_mavjj_JESUp                                                                    = t.p_HadZH_mavjj_JESUp
            self.p_HadZH_mavjj_true_JESUp                                                               = t.p_HadZH_mavjj_true_JESUp
            self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp                                                   = t.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp

            self.M2g1_HadZH_JESUp             *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g4_HadZH_JESUp             *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g1g4_HadZH_JESUp           *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g2_HadZH_JESUp             *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g1g2_HadZH_JESUp           *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g1prime2_HadZH_JESUp       *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g1g1prime2_HadZH_JESUp     *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2ghzgs1prime2_HadZH_JESUp   *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp
            self.M2g1ghzgs1prime2_HadZH_JESUp *= self.p_HadZH_mavjj_JESUp / self.p_HadZH_mavjj_true_JESUp / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESUp

            self.p_HadWH_SIG_ghw1_1_JHUGen_JESUp                    = self.M2g1_HadWH_JESUp             = t.p_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.p_HadWH_SIG_ghw4_1_JHUGen_JESUp                    = self.M2g4_HadWH_JESUp             = t.p_HadWH_SIG_ghw4_1_JHUGen_JESUp
            self.p_HadWH_SIG_ghw1_1_ghw4_1_JHUGen_JESUp             = self.M2g1g4_HadWH_JESUp           = t.p_HadWH_SIG_ghw1_1_ghw4_1_JHUGen_JESUp
            self.p_HadWH_SIG_ghw2_1_JHUGen_JESUp                    = self.M2g2_HadWH_JESUp             = t.p_HadWH_SIG_ghw2_1_JHUGen_JESUp
            self.p_HadWH_SIG_ghw1_1_ghw2_1_JHUGen_JESUp             = self.M2g1g2_HadWH_JESUp           = t.p_HadWH_SIG_ghw1_1_ghw2_1_JHUGen_JESUp
            self.p_HadWH_SIG_ghw1prime2_1_JHUGen_JESUp              = self.M2g1prime2_HadWH_JESUp       = t.p_HadWH_SIG_ghw1prime2_1E4_JHUGen_JESUp / 1e4**2
            self.p_HadWH_SIG_ghw1_1_ghw1prime2_1_JHUGen_JESUp       = self.M2g1g1prime2_HadWH_JESUp     = t.p_HadWH_SIG_ghw1_1_ghw1prime2_1E4_JHUGen_JESUp / 1e4
            self.p_HadWH_SIG_ghza1prime2_1_JHUGen_JESUp             = self.M2ghzgs1prime2_HadWH_JESUp   = 0
            self.p_HadWH_SIG_ghz1_1_ghza1prime2_1_JHUGen_JESUp      = self.M2g1ghzgs1prime2_HadWH_JESUp = 0

            self.p_HadWH_mavjj_JESUp                                                               = t.p_HadWH_mavjj_JESUp
            self.p_HadWH_mavjj_true_JESUp                                                          = t.p_HadWH_mavjj_true_JESUp
            self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp                                                   = t.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp

            self.M2g1_HadWH_JESUp             *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g4_HadWH_JESUp             *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g1g4_HadWH_JESUp           *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g2_HadWH_JESUp             *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g1g2_HadWH_JESUp           *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g1prime2_HadWH_JESUp       *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g1g1prime2_HadWH_JESUp     *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2ghzgs1prime2_HadWH_JESUp   *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp
            self.M2g1ghzgs1prime2_HadWH_JESUp *= self.p_HadWH_mavjj_JESUp / self.p_HadWH_mavjj_true_JESUp / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESUp

            self.p_JQCD_SIG_ghg2_1_JHUGen_JESUp                                                         = t.p_JQCD_SIG_ghg2_1_JHUGen_JESUp
            self.p_JVBF_SIG_ghv1_1_JHUGen_JESUp                                                         = t.p_JVBF_SIG_ghv1_1_JHUGen_JESUp
            self.pAux_JVBF_SIG_ghv1_1_JHUGen_JESUp                                                      = t.pAux_JVBF_SIG_ghv1_1_JHUGen_JESUp

            self.p_JJVBF_S_SIG_ghv1_1_MCFM_JESUp = t.p_JJVBF_S_SIG_ghv1_1_MCFM_JESUp
            self.p_HadZH_S_SIG_ghz1_1_MCFM_JESUp = t.p_HadZH_S_SIG_ghz1_1_MCFM_JESUp
            self.p_HadWH_S_SIG_ghw1_1_MCFM_JESUp = t.p_HadWH_S_SIG_ghw1_1_MCFM_JESUp
            self.p_JJVBF_BKG_MCFM_JESUp = t.p_JJVBF_BKG_MCFM_JESUp
            self.p_HadZH_BKG_MCFM_JESUp = t.p_HadZH_BKG_MCFM_JESUp
            self.p_HadWH_BKG_MCFM_JESUp = t.p_HadWH_BKG_MCFM_JESUp
            self.p_JJQCD_BKG_MCFM_JESUp = t.p_JJQCD_BKG_MCFM_JESUp
            self.p_HadZH_mavjj_JESUp = t.p_HadZH_mavjj_JESUp
            self.p_HadZH_mavjj_true_JESUp = t.p_HadZH_mavjj_true_JESUp
            self.p_HadWH_mavjj_JESUp = t.p_HadWH_mavjj_JESUp
            self.p_HadWH_mavjj_true_JESUp = t.p_HadWH_mavjj_true_JESUp
            self.pConst_JJVBF_S_SIG_ghv1_1_MCFM_JESUp = t.pConst_JJVBF_S_SIG_ghv1_1_MCFM_JESUp
            self.pConst_HadZH_S_SIG_ghz1_1_MCFM_JESUp = t.pConst_HadZH_S_SIG_ghz1_1_MCFM_JESUp
            self.pConst_HadWH_S_SIG_ghw1_1_MCFM_JESUp = t.pConst_HadWH_S_SIG_ghw1_1_MCFM_JESUp
            self.pConst_JJVBF_BKG_MCFM_JESUp = t.pConst_JJVBF_BKG_MCFM_JESUp
            self.pConst_HadZH_BKG_MCFM_JESUp = t.pConst_HadZH_BKG_MCFM_JESUp
            self.pConst_HadWH_BKG_MCFM_JESUp = t.pConst_HadWH_BKG_MCFM_JESUp
            self.pConst_JJQCD_BKG_MCFM_JESUp = t.pConst_JJQCD_BKG_MCFM_JESUp

            self.PFMET_corrected_jesUp = t.PFMET_corrected_jesUp
            self.nCleanedJetsPt30_jesUp = t.nCleanedJetsPt30_jesUp
            ptUp = sorted(((pt*(1+sigma), i) for i, (pt, sigma) in enumerate(izip(t.JetPt, t.JetSigma))), reverse=True)
            jesUpIndices = [i for pt, i in ptUp if pt>30]

            self.Jet1Pt_jesUp = ptUp[0][0] if ptUp else None
            if self.nCleanedJetsPt30_jesUp < 2:
                self.DiJetMass_jesUp = self.DiJetDEta_jesUp = self.HjjPt_jesUp = -99
            else:
                jets_jesUp = [tlvfromptetaphim(pt, t.JetEta[i], t.JetPhi[i], t.JetMass[i]) for pt, i in ptUp[:2]]
                self.DiJetMass_jesUp = (jets_jesUp[0]+jets_jesUp[1]).M()
                self.DiJetDEta_jesUp = jets_jesUp[0].Eta() - jets_jesUp[1].Eta()
                self.HjjPt_jesUp = (Hvector + jets_jesUp[0] + jets_jesUp[1]).Pt() if nCleanedJets >= 2 else -99

            if self.nCleanedJetsPt30 == self.nCleanedJetsPt30_jesUp:
                self.nCleanedJetsPt30BTagged_bTagSF_jesUp = self.nCleanedJetsPt30BTagged_bTagSF
                self.jetQGLikelihood_jesUp = self.jetQGLikelihood
                self.jetPhi_jesUp = self.jetPhi
                #note that this automatically takes care of the dummyfloatstar case, since if there are no jets
                # nCleanedJetsPt30 will be the same as nCleanedJetsPt30_jesUp
            else:
                self.nCleanedJetsPt30BTagged_bTagSF_jesUp = int(sum(t.JetIsBtaggedWithSF[i] for i in jesUpIndices))
                if jesUpIndices == range(self.nCleanedJetsPt30_jesUp):
                    #should happen almost always
                    self.jetQGLikelihood_jesUp = self.jetQGLikelihood
                    self.jetPhi_jesUp = self.jetPhi
                else:
                    self.jetQGLikelihood_jesUp = array("f", [t.JetQGLikelihood[i] for i in jesUpIndices])
                    self.jetPhi_jesUp = array("f", [t.JetPhi[i] for i in jesUpIndices])

            self.notdijet_JESUp = self.M2g1_VBF_JESUp <= 0

            #JESDn
            self.p_JJVBF_SIG_ghv1_1_JHUGen_JESDn                    = self.M2g1_VBF_JESDn               = t.p_JJVBF_SIG_ghv1_1_JHUGen_JESDn
            self.p_JJVBF_SIG_ghv4_1_JHUGen_JESDn                    = self.M2g4_VBF_JESDn               = t.p_JJVBF_SIG_ghv4_1_JHUGen_JESDn
            self.p_JJVBF_SIG_ghv1_1_ghv4_1_JHUGen_JESDn             = self.M2g1g4_VBF_JESDn             = t.p_JJVBF_SIG_ghv1_1_ghv4_1_JHUGen_JESDn
            self.p_JJVBF_SIG_ghv2_1_JHUGen_JESDn                    = self.M2g2_VBF_JESDn               = t.p_JJVBF_SIG_ghv2_1_JHUGen_JESDn
            self.p_JJVBF_SIG_ghv1_1_ghv2_1_JHUGen_JESDn             = self.M2g1g2_VBF_JESDn             = t.p_JJVBF_SIG_ghv1_1_ghv2_1_JHUGen_JESDn
            self.p_JJVBF_SIG_ghv1prime2_1_JHUGen_JESDn              = self.M2g1prime2_VBF_JESDn         = t.p_JJVBF_SIG_ghv1prime2_1E4_JHUGen_JESDn / 1e4**2
            self.p_JJVBF_SIG_ghv1_1_ghv1prime2_1_JHUGen_JESDn       = self.M2g1g1prime2_VBF_JESDn       = t.p_JJVBF_SIG_ghv1_1_ghv1prime2_1E4_JHUGen_JESDn / 1e4
            self.p_JJVBF_SIG_ghza1prime2_1_JHUGen_JESDn             = self.M2ghzgs1prime2_VBF_JESDn     = t.p_JJVBF_SIG_ghza1prime2_1E4_JHUGen_JESDn / 1e4**2
            self.p_JJVBF_SIG_ghv1_1_ghza1prime2_1_JHUGen_JESDn      = self.M2g1ghzgs1prime2_VBF_JESDn   = t.p_JJVBF_SIG_ghv1_1_ghza1prime2_1E4_JHUGen_JESDn / 1e4

            self.p_JJQCD_SIG_ghg2_1_JHUGen_JESDn                    = self.M2g2_HJJ_JESDn               = t.p_JJQCD_SIG_ghg2_1_JHUGen_JESDn
            self.p_JJQCD_SIG_ghg4_1_JHUGen_JESDn                                                        = t.p_JJQCD_SIG_ghg4_1_JHUGen_JESDn
            self.p_JJQCD_SIG_ghg2_1_ghg4_1_JHUGen_JESDn                                                 = t.p_JJQCD_SIG_ghg2_1_ghg4_1_JHUGen_JESDn

            self.p_HadZH_SIG_ghz1_1_JHUGen_JESDn                    = self.M2g1_HadZH_JESDn             = t.p_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.p_HadZH_SIG_ghz4_1_JHUGen_JESDn                    = self.M2g4_HadZH_JESDn             = t.p_HadZH_SIG_ghz4_1_JHUGen_JESDn
            self.p_HadZH_SIG_ghz1_1_ghz4_1_JHUGen_JESDn             = self.M2g1g4_HadZH_JESDn           = t.p_HadZH_SIG_ghz1_1_ghz4_1_JHUGen_JESDn
            self.p_HadZH_SIG_ghz2_1_JHUGen_JESDn                    = self.M2g2_HadZH_JESDn             = t.p_HadZH_SIG_ghz2_1_JHUGen_JESDn
            self.p_HadZH_SIG_ghz1_1_ghz2_1_JHUGen_JESDn             = self.M2g1g2_HadZH_JESDn           = t.p_HadZH_SIG_ghz1_1_ghz2_1_JHUGen_JESDn
            self.p_HadZH_SIG_ghz1prime2_1_JHUGen_JESDn              = self.M2g1prime2_HadZH_JESDn       = t.p_HadZH_SIG_ghz1prime2_1E4_JHUGen_JESDn / 1e4**2
            self.p_HadZH_SIG_ghz1_1_ghz1prime2_1_JHUGen_JESDn       = self.M2g1g1prime2_HadZH_JESDn     = t.p_HadZH_SIG_ghz1_1_ghz1prime2_1E4_JHUGen_JESDn / 1e4
            self.p_HadZH_SIG_ghza1prime2_1_JHUGen_JESDn             = self.M2ghzgs1prime2_HadZH_JESDn   = t.p_HadZH_SIG_ghza1prime2_1E4_JHUGen_JESDn / 1e4**2
            self.p_HadZH_SIG_ghz1_1_ghza1prime2_1_JHUGen_JESDn      = self.M2g1ghzgs1prime2_HadZH_JESDn = t.p_HadZH_SIG_ghz1_1_ghza1prime2_1E4_JHUGen_JESDn / 1e4

            self.p_HadZH_mavjj_JESDn                                                                    = t.p_HadZH_mavjj_JESDn
            self.p_HadZH_mavjj_true_JESDn                                                               = t.p_HadZH_mavjj_true_JESDn
            self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn                                                   = t.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn

            self.M2g1_HadZH_JESDn             *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g4_HadZH_JESDn             *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g1g4_HadZH_JESDn           *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g2_HadZH_JESDn             *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g1g2_HadZH_JESDn           *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g1prime2_HadZH_JESDn       *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g1g1prime2_HadZH_JESDn     *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2ghzgs1prime2_HadZH_JESDn   *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn
            self.M2g1ghzgs1prime2_HadZH_JESDn *= self.p_HadZH_mavjj_JESDn / self.p_HadZH_mavjj_true_JESDn / self.pConst_HadZH_SIG_ghz1_1_JHUGen_JESDn

            self.p_HadWH_SIG_ghw1_1_JHUGen_JESDn                    = self.M2g1_HadWH_JESDn             = t.p_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.p_HadWH_SIG_ghw4_1_JHUGen_JESDn                    = self.M2g4_HadWH_JESDn             = t.p_HadWH_SIG_ghw4_1_JHUGen_JESDn
            self.p_HadWH_SIG_ghw1_1_ghw4_1_JHUGen_JESDn             = self.M2g1g4_HadWH_JESDn           = t.p_HadWH_SIG_ghw1_1_ghw4_1_JHUGen_JESDn
            self.p_HadWH_SIG_ghw2_1_JHUGen_JESDn                    = self.M2g2_HadWH_JESDn             = t.p_HadWH_SIG_ghw2_1_JHUGen_JESDn
            self.p_HadWH_SIG_ghw1_1_ghw2_1_JHUGen_JESDn             = self.M2g1g2_HadWH_JESDn           = t.p_HadWH_SIG_ghw1_1_ghw2_1_JHUGen_JESDn
            self.p_HadWH_SIG_ghw1prime2_1_JHUGen_JESDn              = self.M2g1prime2_HadWH_JESDn       = t.p_HadWH_SIG_ghw1prime2_1E4_JHUGen_JESDn / 1e4**2
            self.p_HadWH_SIG_ghw1_1_ghw1prime2_1_JHUGen_JESDn       = self.M2g1g1prime2_HadWH_JESDn     = t.p_HadWH_SIG_ghw1_1_ghw1prime2_1E4_JHUGen_JESDn / 1e4
            self.p_HadWH_SIG_ghza1prime2_1_JHUGen_JESDn             = self.M2ghzgs1prime2_HadWH_JESDn   = 0
            self.p_HadWH_SIG_ghz1_1_ghza1prime2_1_JHUGen_JESDn      = self.M2g1ghzgs1prime2_HadWH_JESDn = 0

            self.p_HadWH_mavjj_JESDn                                                                    = t.p_HadWH_mavjj_JESDn
            self.p_HadWH_mavjj_true_JESDn                                                               = t.p_HadWH_mavjj_true_JESDn
            self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn                                                   = t.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn

            self.M2g1_HadWH_JESDn             *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g4_HadWH_JESDn             *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g1g4_HadWH_JESDn           *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g2_HadWH_JESDn             *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g1g2_HadWH_JESDn           *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g1prime2_HadWH_JESDn       *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g1g1prime2_HadWH_JESDn     *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2ghzgs1prime2_HadWH_JESDn   *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn
            self.M2g1ghzgs1prime2_HadWH_JESDn *= self.p_HadWH_mavjj_JESDn / self.p_HadWH_mavjj_true_JESDn / self.pConst_HadWH_SIG_ghw1_1_JHUGen_JESDn

            self.p_JQCD_SIG_ghg2_1_JHUGen_JESDn                                                         = t.p_JQCD_SIG_ghg2_1_JHUGen_JESDn
            self.p_JVBF_SIG_ghv1_1_JHUGen_JESDn                                                         = t.p_JVBF_SIG_ghv1_1_JHUGen_JESDn
            self.pAux_JVBF_SIG_ghv1_1_JHUGen_JESDn                                                      = t.pAux_JVBF_SIG_ghv1_1_JHUGen_JESDn

            self.p_JJVBF_S_SIG_ghv1_1_MCFM_JESDn = t.p_JJVBF_S_SIG_ghv1_1_MCFM_JESDn
            self.p_HadZH_S_SIG_ghz1_1_MCFM_JESDn = t.p_HadZH_S_SIG_ghz1_1_MCFM_JESDn
            self.p_HadWH_S_SIG_ghw1_1_MCFM_JESDn = t.p_HadWH_S_SIG_ghw1_1_MCFM_JESDn
            self.p_JJVBF_BKG_MCFM_JESDn = t.p_JJVBF_BKG_MCFM_JESDn
            self.p_HadZH_BKG_MCFM_JESDn = t.p_HadZH_BKG_MCFM_JESDn
            self.p_HadWH_BKG_MCFM_JESDn = t.p_HadWH_BKG_MCFM_JESDn
            self.p_JJQCD_BKG_MCFM_JESDn = t.p_JJQCD_BKG_MCFM_JESDn
            self.p_HadZH_mavjj_JESDn = t.p_HadZH_mavjj_JESDn
            self.p_HadZH_mavjj_true_JESDn = t.p_HadZH_mavjj_true_JESDn
            self.p_HadWH_mavjj_JESDn = t.p_HadWH_mavjj_JESDn
            self.p_HadWH_mavjj_true_JESDn = t.p_HadWH_mavjj_true_JESDn
            self.pConst_JJVBF_S_SIG_ghv1_1_MCFM_JESDn = t.pConst_JJVBF_S_SIG_ghv1_1_MCFM_JESDn
            self.pConst_HadZH_S_SIG_ghz1_1_MCFM_JESDn = t.pConst_HadZH_S_SIG_ghz1_1_MCFM_JESDn
            self.pConst_HadWH_S_SIG_ghw1_1_MCFM_JESDn = t.pConst_HadWH_S_SIG_ghw1_1_MCFM_JESDn
            self.pConst_JJVBF_BKG_MCFM_JESDn = t.pConst_JJVBF_BKG_MCFM_JESDn
            self.pConst_HadZH_BKG_MCFM_JESDn = t.pConst_HadZH_BKG_MCFM_JESDn
            self.pConst_HadWH_BKG_MCFM_JESDn = t.pConst_HadWH_BKG_MCFM_JESDn
            self.pConst_JJQCD_BKG_MCFM_JESDn = t.pConst_JJQCD_BKG_MCFM_JESDn

            self.PFMET_corrected_jesDn = t.PFMET_corrected_jesDn
            self.nCleanedJetsPt30_jesDn = t.nCleanedJetsPt30_jesDn
            ptDn = sorted(((pt*(1+sigma), i) for i, (pt, sigma) in enumerate(izip(t.JetPt, t.JetSigma))), reverse=True)
            jesDnIndices = [i for pt, i in ptDn if pt>30]

            self.Jet1Pt_jesDn = ptDn[0][0] if ptDn else None
            if self.nCleanedJetsPt30_jesDn < 2:
                self.DiJetMass_jesDn = self.DiJetDEta_jesDn = self.HjjPt_jesDn = -99
            else:
                jets_jesDn = [tlvfromptetaphim(pt, t.JetEta[i], t.JetPhi[i], t.JetMass[i]) for pt, i in ptDn[:2]]
                self.DiJetMass_jesDn = (jets_jesDn[0]+jets_jesDn[1]).M()
                self.DiJetDEta_jesDn = jets_jesDn[0].Eta() - jets_jesDn[1].Eta()
                self.HjjPt_jesDn = (Hvector + jets_jesDn[0] + jets_jesDn[1]).Pt() if nCleanedJets >= 2 else -99

            if self.nCleanedJetsPt30 == self.nCleanedJetsPt30_jesDn:
                self.nCleanedJetsPt30BTagged_bTagSF_jesDn = self.nCleanedJetsPt30BTagged_bTagSF
                self.jetQGLikelihood_jesDn = self.jetQGLikelihood
                self.jetPhi_jesDn = self.jetPhi
                #note that this automatically takes care of the dummyfloatstar case, since if there are no jets
                # nCleanedJetsPt30 will be the same as nCleanedJetsPt30_jesDn
            else:
                self.nCleanedJetsPt30BTagged_bTagSF_jesDn = int(sum(t.JetIsBtaggedWithSF[i] for i in jesDnIndices))
                if jesDnIndices == range(self.nCleanedJetsPt30_jesDn):
                    #should happen almost always
                    self.jetQGLikelihood_jesDn = self.jetQGLikelihood
                    self.jetPhi_jesDn = self.jetPhi
                else:
                    self.jetQGLikelihood_jesDn = array("f", [t.JetQGLikelihood[i] for i in jesDnIndices])
                    self.jetPhi_jesDn = array("f", [t.JetPhi[i] for i in jesDnIndices])

            self.notdijet_JESDn = self.M2g1_VBF_JESDn <= 0
...
#############
    ...
    def initlists(self):
        ...
        self.exceptions = [
            ...
            "binning_4couplings_VBFdecay_JESUp",
            "binning_4couplings_VBFdecay_JESDn",
            "binning_4couplings_VBFdecay_JERUp",
            "binning_4couplings_VBFdecay_JERDn",
            "binning_4couplings_HadVHdecay",
            "binning_4couplings_HadVHdecay_JECUp",
            "binning_4couplings_HadVHdecay_JECDn",
            "binning_4couplings_HadVHdecay_JESUp",
            "binning_4couplings_HadVHdecay_JESDn",
            "binning_4couplings_HadVHdecay_JERUp",
            "binning_4couplings_HadVHdecay_JERDn",
            "binning_4couplings_photons_decay",
            "binning_4couplings_photons_VBF",
            "binning_4couplings_photons_VBF_JECUp",
            "binning_4couplings_photons_VBF_JECDn",
            "binning_4couplings_photons_VBF_JESUp",
            "binning_4couplings_photons_VBF_JESDn",
            "binning_4couplings_photons_VBF_JERUp",
            "binning_4couplings_photons_VBF_JERDn",
            "binning_4couplings_photons_VBFdecay",
            ...
            "binning_4couplings_photons_HadVH",
            "binning_4couplings_photons_HadVH_JECUp",
            "binning_4couplings_photons_HadVH_JECDn",
            "binning_4couplings_photons_HadVH_JESUp",
            "binning_4couplings_photons_HadVH_JESDn",
            "binning_4couplings_photons_HadVH_JERUp",
            "binning_4couplings_photons_HadVH_JERDn",
            "binning_4couplings_photons_HadVHdecay",
            ...
            "D_bkg_kin_VBFdecay_JESUp",
            "D_bkg_kin_VBFdecay_JESDn",
            "D_bkg_kin_VBFdecay_JERUp",
            "D_bkg_kin_VBFdecay_JERDn",
            "D_bkg_kin_HadVHdecay",
            "D_bkg_kin_HadVHdecay_JECUp",
            "D_bkg_kin_HadVHdecay_JECDn",
            "D_bkg_kin_HadVHdecay_JESUp",
            "D_bkg_kin_HadVHdecay_JESDn",
            "D_bkg_kin_HadVHdecay_JERUp",
            "D_bkg_kin_HadVHdecay_JERDn",
        ...
        STXSdiscriminants = [
            ...
            "D_4couplings_photons_VBF_raw",
            #"D_4couplings_photons_VBF",
            "D_4couplings_photons_VBFdecay_raw",
            #"D_4couplings_photons_VBFdecay",
            "D_4couplings_photons_HadVH_raw",
            #"D_4couplings_photons_HadVH",
        ...
        for JEC in "", "_JECUp", "_JECDn", "_JESUp", "_JESDn", "_JERUp", "_JERDn":
            lst, lstint = (self.toaddtotree, self.toaddtotree_int) if (JEC == "" or "JEC" in JEC and self.useJEC or "JES" in JEC and self.useJES or "JER" in JEC and self.useJER) else (self.exceptions, self.exceptions)
            for prod in ("VBF", "HadVH"):
                lst += [_.format(prod=prod)+JEC for _ in proddiscriminants]
