...
discriminants = {
    d.name: d for d in [
        ...
        Discriminant("D_CP_ZH_hadronic", "D_{CP}^{ZHh}", 20, -.4, .4),
        Discriminant("D_g2_ZH_hadronic", "D_{0h+}^{ZHh}", 20, 0, 1),
        Discriminant("D_g1g2_ZH_hadronic", "D_{int}^{ZHh}", 20, -1, .05),
        Discriminant("D_g1prime2_ZH_hadronic", "D_{#Lambda1}^{ZHh}", 20, 0, 1),
        Discriminant("D_g1g1prime2_ZH_hadronic", "D_{#Lambda1int}^{ZHh}", 20, 0, 1),
        ...
        Discriminant("D_g1g2_WH_hadronic", "D_{int}^{WHh}", 20, -1, .05),
        Discriminant("D_g1prime2_WH_hadronic", "D_{#Lambda1}^{WHh}", 20, 0, 1),
        Discriminant("D_g1g1prime2_WH_hadronic", "D_{#Lambda1int}^{WHh}", 20, 0, 1),
