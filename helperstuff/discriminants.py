...
#            for i in range(1, 4)
        ...
        Discriminant("D_g2_HadZH", "D_{0h+}^{ZH}", defaultnbins, 0, 1),
        Discriminant("D_g1g2_HadZH", "D_{int}^{ZH}", defaultnbins, -1, .05),
        Discriminant("D_g1prime2_HadZH", "D_{#Lambda1}^{ZH}", defaultnbins, 0, 1),
        Discriminant("D_g1g1prime2_HadZH", "D_{#Lambda1int}^{ZH}", defaultnbins, 0, 1),
        Discriminant("D_0minus_HadZHdecay", "D_{0-}^{ZHdec}", defaultnbins, 0, 1),
        Discriminant("D_g2_HadZHdecay", "D_{0h+}^{ZHdec}", defaultnbins, 0, 1),
        Discriminant("D_g1prime2_HadZHdecay", "D_{#Lambda1}^{ZHdec}", defaultnbins, 0, 1),
#    ] + [
#        Discriminant(
...
#            for i in range(1, 4)
        ...
        Discriminant("D_g2_HadWH", "D_{0h+}^{WH}", defaultnbins, 0, 1),
        Discriminant("D_g1g2_HadWH", "D_{int}^{WH}", defaultnbins, -1, .05),
        Discriminant("D_g1prime2_HadWH", "D_{#Lambda1}^{WH}", defaultnbins, 0, 1),
        Discriminant("D_g1g1prime2_HadWH", "D_{#Lambda1int}^{WH}", defaultnbins, 0, 1),
        Discriminant("D_0minus_HadWHdecay", "D_{0-}^{WHdec}", defaultnbins, 0, 1),
        Discriminant("D_g2_HadWHdecay", "D_{0h+}^{WHdec}", defaultnbins, 0, 1),
        Discriminant("D_g1prime2_HadWHdecay", "D_{#Lambda1}^{WHdec}", defaultnbins, 0, 1),
#    ] + [
#        Discriminant(
...
#            for i in range(1, 4)
        ...
        Discriminant("D_g2_HadVH", "D_{0h+}^{VH}", defaultnbins, 0, 1),
        Discriminant("D_g1g2_HadVH", "D_{int}^{VH}", defaultnbins, -1, .05),
        Discriminant("D_g1prime2_HadVH", "D_{#Lambda1}^{VH}", defaultnbins, 0, 1),
        Discriminant("D_g1g1prime2_HadVH", "D_{#Lambda1int}^{VH}", defaultnbins, 0, 1),
