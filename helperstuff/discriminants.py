...
decaydiscriminants = [
    ...
    Discriminant("D_4couplings_decay", "D_{4}^{dec}", 162, 0, 162),
]
VBFdiscriminants = [
    ...
    Discriminant("D_4couplings_VBFdecay", "D_{4}^{VBF+dec}", 162, 0, 162),
]
VHdiscriminants = [
    ...
    Discriminant("D_4couplings_HadVHdecay", "D_{4}^{VH+dec}", 162, 0, 162),
]
