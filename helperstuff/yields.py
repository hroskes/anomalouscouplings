...
class YieldSystematicValue(MultiEnum, JsonDict):
    ...
    def copyfromotheryieldsystematicvalue(self):
        ...
        if self.production in "190703_2016" and self.yieldsystematic == "CMS_pythia_scale":
            kwargs["production"] = "190703_2017"
        elif self.production in "190821_2016" and self.yieldsystematic == "CMS_pythia_scale":
